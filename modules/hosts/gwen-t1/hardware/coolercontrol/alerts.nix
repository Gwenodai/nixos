{ den, lib, ... }: {
  den.aspects.gwen-t1 = {
    includes = [ den.aspects.coolercontrol._.manualConfig._.alerts ];
    coolercontrol-alerts = {
      mode = "0644";
      text = let
        # ---Hardware device IDs--- #
        cpu = # 9800X3D
      ...
      in # Stupid extension... Nix highlighting is close enough to make toml readable

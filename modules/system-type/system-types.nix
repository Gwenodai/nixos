{ __findFile, den, ... }:
{
  den.aspects.system-type.basic.includes = with den.aspects; [
    ### Core Aspects
    xdg
  ...
  den.aspects.system-type.desktop.includes = with den.aspects; [
  ...
  den.aspects.system-type.desktop-gaming = {
